...
create table `student_course` (
    ...
    # 	: student_id, course_id가 함께 기본 키 역할을 함 
...
values
	...
	(2, 101),
	(3, 101),
	(3, 103);	-- 복합 키 설정이기 때문에 두 개의 컬럼을 합친 내용이 다른 레코드와 중복되어서는 X
